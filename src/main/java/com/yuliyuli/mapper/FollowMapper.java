...
import com.yuliyuli.entity.info.Follow;
...
public interface FollowMapper extends BaseMapper<Follow> {
   ...
   */
  @Select(
      "select * from follow where follow_user_id = #{followUserId} and fan_user_id = #{fanUserId}")
   ...
   */
  @Delete(
      "delete from follow where follow_user_id = #{followUserId} and fan_user_id = #{fanUserId}")
