  ...
  <div class="home">
    ...
    <nav class="category-nav">
      <div class="category-content">
        <router-link to="/hot" class="category-item" :class="{ active: $route.path === '/hot' }">热门</router-link>
        <router-link to="/category/1" class="category-item" :class="{ active: $route.path === '/category/1' }">番剧</router-link>
        <router-link to="/category/2" class="category-item" :class="{ active: $route.path === '/category/2' }">综艺</router-link>
        <router-link to="/category/3" class="category-item" :class="{ active: $route.path === '/category/3' }">科技</router-link>
        <router-link to="/category/4" class="category-item" :class="{ active: $route.path === '/category/4' }">生活</router-link>
        <router-link to="/category/5" class="category-item" :class="{ active: $route.path === '/category/5' }">音乐</router-link>
        <router-link to="/category/6" class="category-item" :class="{ active: $route.path === '/category/6' }">舞蹈</router-link>
        <router-link to="/category/7" class="category-item" :class="{ active: $route.path === '/category/7' }">美食</router-link>
        <router-link to="/category/8" class="category-item" :class="{ active: $route.path === '/category/8' }">汽车</router-link>
        <router-link to="/category/9" class="category-item" :class="{ active: $route.path === '/category/9' }">体育</router-link>
        <router-link to="/category/10" class="category-item" :class="{ active: $route.path === '/category/10' }">游戏</router-link>
      </div>
    </nav>
    ...
    <main class="video-content">
      ...
      <div v-else-if="!hasMore && videos.length > 0" class="no-more" 
        ...
        <div class="login-content">
          ...
          <div class="login-body">
            <div class="qr-code-section">
              <div class="qr-code">
                <img src="C:\Users\Administrator\Desktop\yuliyuli_enterprise\yuliyuli-frontend\static\images\OIP-C.webp" alt="登录二维码" />
