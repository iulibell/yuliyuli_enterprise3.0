  ...
  <div class="video-manager-page">
    ...
    <main class="manager-content">
      ...
      <div class="manager-tabs">
        <div class="tab-item" :class="{ active: activeTab === 'video' }" @click="handleTabClick('video')">视频管理</div>
        <div class="tab-item" :class="{ active: activeTab === 'collection' }" @click="handleTabClick('collection')">合集管理</div>
        <div class="tab-item" :class="{ active: activeTab === 'image' }" @click="handleTabClick('image')">图文管理</div>
        <div class="tab-item" :class="{ active: activeTab === 'interactive' }" @click="handleTabClick('interactive')">互动视频管理</div>
        <div class="tab-item" :class="{ active: activeTab === 'audio' }" @click="handleTabClick('audio')">音频管理</div>
        <div class="tab-item" :class="{ active: activeTab === 'sticker' }" @click="handleTabClick('sticker')">贴纸管理</div>
        <div class="tab-item" :class="{ active: activeTab === 'material' }" @click="handleTabClick('material')">视频素材管理</div>
      ...
      <div class="status-tabs">
        ...
        <div class="action-buttons">
          <el-button type="primary" style="background-color: #1890ff; color: white; border-radius: 4px; border: none;">
            + 添加合集
          </el-button>
        ...
        <div v-if="videoList.length > 0">
          <div v-for="video in videoList" :key="video.id" class="video-item">
            <div class="video-info">
              ...
              <div class="video-details">
                ...
                <div class="video-stats">
                  <span><i class="el-icon-video-camera"></i> {{ formatPlayCount(video.playCount) }}</span>
            ...
            <div class="video-actions">
              <el-button type="default" style="margin-right: 10px;" @click="handleDeleteVideo(video.url, video.userId || 0)">
...
// 用户ID
const userId = ref<string>(route.params.userId as string || route.query.userId as string || localStorage.getItem('userId') || '');
...
const handleDeleteVideo = async (videoUrl: string, userIdValue: number) => {
  try {
    ...
    const response = await axios.post('/api/info/videoDelete' , {
      videoUrl: videoUrl,
      userId: userIdValue
    }, {
      headers: {
